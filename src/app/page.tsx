...
export default async function Home() {
  ...
  return <Page>
    ...
    <section className="section planning-home"><div><p className="eyebrow">Planning interentreprises</p><h2>Choisir une prochaine session.</h2><p className="lead small">SST initiale à partir de <b>150 € HT par personne</b>. Les dates sont confirmées au devis accepté.</p></div><TrainingCalendar sessions={sessions}/><Link href="/planning" className="text-link">Voir le planning complet <span>→</span></Link></section>
